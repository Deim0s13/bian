...
|---|---|---|---|---|---|---|
| WRK-001 | Confirm the primary user, sponsor, decision, trigger, and bounded HSB scope. | OQ-001 through OQ-003 and OQ-012 have accepted answers or explicit bounded hypotheses. | Product authority | Planned | WRK-016, WRK-018 | 2026-08-17 |
...
| WRK-016 | Review and accept, revise, or reject the overarching project principles baseline. | Every `PRN` item has an explicit project-owner outcome and material changes are reflected in related requirements and decisions. | Project owner | Planned | WRK-015 | 2026-08-17 |
...
| WRK-018 | Review and accept, revise, defer, or reject the cross-cutting requirements baseline. | Every `REQ` record has an explicit project-owner outcome, owner, source, acceptance evidence, and relationship to affected Business Architecture requirements. | Project owner | Planned | WRK-016, WRK-017 | 2026-08-17 |
